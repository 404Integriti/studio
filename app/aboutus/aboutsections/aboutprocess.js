...
export default function Aboutprocess() {
  return (
    <div className="process-container w-full max-w-[1440px] mx-auto flex items-start lg:flex-row flex-col pt-[60px]">
      ...
      <div className="process-content lg:mt-[60px] mt-[10px] lg:mb-[0px] mb-[40px] pb-[20px] w-full lg:max-w-[650px] max-w-[100%] lg:h-[686px] h-auto flex flex-col items-center justify-center" style={{
