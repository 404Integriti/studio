...
export default function CommunityPurpose() {
  return (
    <section className="community-purpose-section">
        <div className="w-[100%] max-w-[1905px] lg:px-[110px] lg:h-[550px] h-autoflex flex lg:flex-row flex-col-reverse pl-[25px] items-center mx-auto " style={{
                backgroundImage: "linear-gradient(#fff, #f6f6f6 4% 11%)",
            }}>
         
                <div className="w-[100%] lg:max-w-[838px] max-w-[100%] lg:pt-[50px] pt-[60px]">
