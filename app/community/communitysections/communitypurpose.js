...
export default function CommunityPurpose() {
  return (
    <section className="community-purpose-section">
        <div className="w-[100%] max-w-[1905px] lg:h-[700px] h-autoflex flex lg:flex-row flex-col justify-center items-center mx-auto pt-[20px]" style={{
                backgroundImage: "linear-gradient(#fff, #f6f6f6 4% 11%)",
            }}>
         
                <div className="w-[100%] lg:max-w-[838px] max-w-[100%] lg:pt-[100px] pt-[60px]">
                    <Image className="footer-float lg:mx-[0] mx-auto lg:px-[0px] px-[30px] block" src="/community.svg" width={804} height={675} alt="" />

                </div>
                <div className="w-[100%] lg:max-w-[680px] max-w-[100%] mt-[82px] lg:pr-[30px] pr-[20px] lg:pl-[0px] pl-[20px] lg:pb-[60px] pb-[40px]">
