...
export default function Anzhero() {
  return (
    <Herosection
      ...
      heading={
        <>
          <span className="hero-orange"><span className="text-[#333333]">Evolution for a Major </span>Beauty Brand in ANZ</span>
        </>
      }
      ...
      paragraph={<>When a top tier beauty brand set out to elevate its digital storefront across two countries, Integriti Studio stepped in to lead the transformation. We redesigned their Shopify presence for both Australia and New Zealand, creating a visually rich, high-performing eCommerce experience that aligned perfectly with the brand’s bold identity.
</>}
