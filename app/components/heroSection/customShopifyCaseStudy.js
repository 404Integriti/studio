...
export default function CustomShopifyCaseStudy() {
  return (
    <Herosection
      ...
      heading={
        <>
          <span className="hero-orange">Custom Shopify<span className="text-[#333333]"> Application For Custom Shipping Prices</span></span> 
        </>
      }
      ...
      paragraph={<>An eCommerce business with multiple physical stores in the USA needed a custom Shopify app to handle their shipping and in-store pickup efficiently. Their goal was to allow customers to select their preferred store at checkout while automatically adjusting shipping costs based on location. Since they were on the Shopify Basic plan, they required a tailored solution without upgrading to Shopify Plus.
