...
export default function Dentalcasehero() {
  return (
    <Herosection
      ...
      heading={
        <>
          <span className="hero-orange ">
            Dental <span className="text-[#333333]">Products</span>
          </span>
        </>
      }
      ...
      paragraph={
        <>
          Zendora Dental, an eCommerce business, needed a custom Shopify
          solution to apply location-based discounts at checkout while
          maintaining real-time pricing from their ERP system. They wanted to
          streamline the checkout process and automate discount applications
          without upgrading to Shopify Plus
          <br /> <br />
          Our team developed a tailored Shopify integration that enabled
          automatic discounting based on customer location and ensured real-time
          price synchronization with their ERP system.
        </>
      }
