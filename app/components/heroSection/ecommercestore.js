...
export default function EcommerceStoreSection() {
  return (
    <Herosection
      ...
      paragraph={<>Integriti Studio partnered with an online retailer specializing in beauty and healthcare products to revamp their eCommerce platform. The goal was to streamline the shopping experience, improve product discoverability, and drive real business growth.
