...
export default function Pharmaceutical() {
  return (
    <Herosection
      ...
      heading={
        <>
          <span className="hero-orange">Pharmaceutical<span className="text-[#333333]"> Company </span></span>
        </>
      }
      ...
      paragraph={<>We collaborated with Nett Pharmacy. A pharmaceutical and beauty products retailer, to build a modern Shopify store that’s both user friendly and efficient.  <br></br><br></br> Our goal was to highly enhance product visibility, streamline navigation and create a seamless shopping experience. By focusing on intuitive design and optimized content. We ensured customers could easily find what they need. </>}
