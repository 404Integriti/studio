...
export default function PlushieCaseHero() {
  return (
    <Herosection
      ...
      heading={
        <>
          <span className="hero-orange">
            Plushie Toy <span className="text-[#333333]">Store</span>
          </span>
        </>
      }
      ...
      paragraph={
        <>
          A plushie toy store needed a Shopify store built from scratch within a
          week. The goal was to create a professional, user-friendly platform
          capable of handling global transactions, managing promotions, and
          providing a seamless shopping experience for customers worldwide.
        </>
      }
