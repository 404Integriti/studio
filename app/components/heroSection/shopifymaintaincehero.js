...
export default function shopifymaintenance() {
  return (
    <Herosection
      ...
      heading={
        <>
          Keep Your <span className="hero-orange">Shopify Store</span> Healthy &
          High-Performing
        </>
      }
      headingClass="lg:max-w-[900px] text-[#333333] md:max-w-[740px] mx-auto text-center mt-[20px] mb-[20px] lg:leading-[68px] lg:text-[60px] md:text-[36px] text-[28px] md:leading-[55px] leading-[40px] font-[800]
                    "
      ...
      paragraphClass="max-w-[722px] mx-auto text-center mt-[15px] lg:text-[20px] text-[16px] leading-[32px] leading-[28px] text-[#333333] "
      buttons={
        <Herobutton
