...
export default function SkinCareClinic() {
  return (
    <Herosection
      ...
      heading={
        <>
          <span className="hero-orange">
            Skin And Hair<span className="text-[#333333]"> Clinic</span>
          </span>
        </>
      }
      ...
      paragraph={
        <>
          When a skincare and haircare brand approached us, they had a clear
          vision—build a professional, user-friendly Shopify store and WordPress
          website that would offer a seamless shopping experience while
          reflecting their brand’s personality. We delivered a polished
          eCommerce platform with intuitive navigation, stunning visuals and a
