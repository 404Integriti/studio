...
export default function SkinSection() {
  return (
    <Herosection
        ...
        <>
          <span className="hero-orange">
            ...
            <span className="text-[#333333]">
              Clinic Shopify Store & Dermatology Clinic
            </span>{" "}
            Wordpress Website
          </span>
        </>
      ...
      paragraph={
        <>
          A leading cosmetology clinic wanted to establish a strong online
          presence with a well-structured WordPress website. Their goal was to
          showcase their expertise in skin and hair care while simplifying the
          appointment booking process <br></br>
          We worked closely with the client to organize their content and refine
          their service offerings. The website was built from scratch using
          Elementor page builder and the Hello Elementor theme for fast loading.
          With a user-friendly UI/UX, compressed WebP images, and seamless
          navigation, we ensured a smooth browsing experience for visitors.{" "}
        </>
      }
