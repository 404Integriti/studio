...
export default function Wordpressdevelopmenthero() {
  return (
    <Herosection
      ...
      heading={
        <>
          <span className="hero-orange ">WordPress Development That Works for You</span>
        </>
      }
      ...
      At Integriti Studio, we design and build custom WordPress websites that are fast, scalable  and user friendly. Whether you are an agency looking for white label support, a business ready to scale or a brand that needs a powerful online presence. We’ve got you covered. With WordPress as our core CMS, we deliver flexible solutions that grow with you.</>}
