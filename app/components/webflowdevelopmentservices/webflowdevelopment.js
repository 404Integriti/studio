...
import { webflowDevelopment } from "../../components/customThemePoints";

export default function WebflowDevelopment() {
  return (
    <div className="shopify-service-block flex flex-col gap-[20px] max-w-[560px]">
      {webflowDevelopment.map((item, index) => (
        <div key={index} className="flex">
          {/* Left column */}
          <div className="flex flex-col justify-start items-center w-[100%] max-w-[60px] relative">
          <div className="bg-[#ed8104] rounded-[100%]  z-50 w-[100%] max-w-[60px] h-[60px] flex justify-center items-center left-col relative">
