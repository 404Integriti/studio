...
import {CustomCaseStudy} from "../../components/customThemePoints"
  ...
  return (
    <section className="securitybackup py-[40px]  lg:pt-[82px] lg:pb-[85px]  bg-[#f6f6f6]">
      <div className="w-[100%] max-w-[1360px] lg:px-[10px] px-[20px] flex mx-auto lg:flex-row flex-col lg:gap-[16px] gap-[50px] relative z-40">
        {/* Left column */}
        <div className="lg:w-[100%]  lg:max-w-[608px] max-w-[100%]">
          <h2
            className="lg:text-[36px] md:text-[30px] text-[28px] lg:leading-[58px] md:leading-[50px] leading-[40px] text-[#333] font-[700] lg:text-left text-center lg:mt-[40px]  mb-[10px] "
        ...
        {/* Right column */}
        <div className="lg:w-[65%]  lg:mt-[60px] max-w-[768px]  mx-auto">
          <div className="flex flex-col justify-center gap-[20px] security">
            {CustomCaseStudy.map((item, index) => (
              <div
                key={index}
        ...
        <Image
            src="/CarShopifyApplication.png"
            height={500}
            width={680}
            className="absolute xl:top-[16%] lg:top-[22%] xl:w-[50%] lg:w-[59%] bottom-auto left-[-220px]  z-30 hidden lg:block"
            alt="security"
        />
      </div>
    </section>
