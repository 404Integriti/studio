...
const ProductOffering = () => {
  ...
  const accordionItems = [
    {
      id: 1,
      title: "Tailored Shopify App",
      description: "Built to support custom shipping rules and profile logic specifically for multiple store locations.",
      isActive: activeAccordion === 1
    },
    {
      id: 2,
      title: "Effortless Backend Integration ",
      description: "Embedded within Shopify’s admin for straightforward control and updates.",
      isActive: activeAccordion === 2
    },
    {
      id: 3,
      title: "Intuitive User Interface",
      description: "Designed using Polaris and React to ensure a clean and user-friendly experience.",
      isActive: activeAccordion === 3
    },
    {
      id: 4,
      title: "Location-Based Pricing ",
      description: "WebP images and responsive dEnabled automated shipping price adjustments based on customer selection. esign to reduce load times and improve UX..",
      ...
      <div className="w-full max-w-[1200px] mx-auto  ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden  lg:flex justify-end">
            ...
            <Image 
              src="/customShopifyMobileLogo.png"
              width={459}
              height={297}
