...
const impacts = [
  {
      title: "Cost Savings",
    description: "Successfully launched a full Shopify store in 7 days, meeting the urgent deadline",
    bgColor: "bg-[#cceae7]",
    image: '/cost.png',
  ...
  {
    title: "Better Checkout Flow ",
    description: "Enhanced navigation and real-time support led to a smoother shopping journey and better satisfaction.",
    bgColor: "bg-[#fadbd1]",
    image: '/improved.png',
  ...
  {
    title: "Feedback",
    description: "Increased traffic and a 30% drop in bounce rate contributed to stronger online sales performance.",
    bgColor: "bg-[#cceae7]",
    image: '/cost.png',
    headingClass: "text-[32px] font-[600] mt-[21px] mb-[10px]  text-[#333] leading-[34px]",
