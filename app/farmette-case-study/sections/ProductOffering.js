...
const ProductOffering = () => {
  ...
  const accordionItems = [
    {
      id: 1,
      title: "Customized Shopify Store",
      description: "A fully tailored eCommerce platform reflecting the brand’s identity and values.",
      isActive: activeAccordion === 1
    },
    {
      id: 2,
      title: "Engaging Product Display",
      description: "Multi-currency pricin High-quality imagery paired with clear, compelling product descriptions.g and SEO-optimized content to attract and retain UAE",
      isActive: activeAccordion === 2
    },
    {
      id: 3,
      title: "Seamless User Navigation",
      description: "Well-designed interface enabling effortless browsing and quick purchases.",
      isActive: activeAccordion === 3
    },
    {
      id: 4,
      title: "Mobile-Friendly Experience",
      description: "Responsive design ensuring smooth functionality across all devices.",
