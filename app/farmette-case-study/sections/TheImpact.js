...
const impacts = [
  {
      title: <>Brand<br />Awareness</>,
    description: "A polished website that attracted and retained more organic goods customers.",
    bgColor: "bg-[#cceae7]",
    image: '/cost.png',
  ...
  },
  {
    ...
    description: "Improved navigation increased user engagement and product visibility.",
    bgColor: "bg-[#fadbd1]",
    image: '/improved.png',
  ...
  },
  {
    ...
    description: "Streamlined shopping process led to higher conversion rates and customer satisfaction.",
    bgColor: "bg-[#cceae7]",
    image: '/cost.png',
    headingClass: "text-[32px] font-[600] mt-[21px] mb-[10px]  text-[#333] leading-[34px]",
