  ...
  const accordionItems = [
    {
      ...
      description: "Built the entire store from the ground up with a conversion-focused UI/UX, ensuring smooth navigation, mobile responsiveness, and high engagement.",
      ...
      <div className="w-full max-w-[1200px] mx-auto  ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden  lg:flex justify-end">
            ...
            <Image 
              src="/MobileLogoPharmacetucial.png"
              width={459}
              height={297}
