  ...
  const accordionItems = [
    {
      ...
      description: "A reorganized product structure designed to make browsing easy and efficient for customers.",
      isActive: activeAccordion === 1
    },
    {
      id: 2,
      title: "Engaging Product Displays",
      description: "High-quality visuals and videos paired with compelling descriptions to increase product appeal.",
      isActive: activeAccordion === 2
    },
    {
      id: 3,
      title: "Personalized Shopping Experience",
      description: "Smart product recommendations tailored to user preferences and purchase history.",
      isActive: activeAccordion === 3
    },
    {
      id: 4,
      title: "Streamlined Checkout Process",
      description: " A frictionless and user-friendly checkout experience to improve conversion rates.",
