...
const impacts = [
  {
    ...
    description: "The revamped navigation and product content made it easier for customers to find what they need.",
    bgColor: "bg-[#cceae7]",
    image: '/cost.png',
  ...
  },
  {
    ...
    description: "Personalized product suggestions increased user satisfaction and time spent on site.",
    bgColor: "bg-[#fadbd1]",
    image: '/improved.png',
  ...
  {
    title: "Conversion",
    description: "Optimized checkout flow significantly reduced cart abandonment and boosted sales.",
    bgColor: "bg-[#cceae7]",
    image: '/cost.png',
    headingClass: "text-[32px] font-[600] mt-[21px] mb-[10px]  text-[#333] leading-[34px]",
