...
export default function ResourcesCard({ title, link }) {
  return (
    <div   className="w-full max-w-[342px] h-[300px] flex flex-col justify-center items-center bg-cover bg-center"
          style={{ backgroundImage: `url("/resourcesbg.svg")` }}>
   
 
          <div className="w-full max-w-[322px] px-[10px]  flex flex-col relative">
            <h3
