...
const shopifycardData = [
  ...
  },
  {
    ...
    text: "Our themes aren’t just beautiful—they’re optimized for performance and future growth. From clean code to responsive layouts, every detail is scalable",
    rotate: "-4deg"
  },
];
  ...
  return (
   <section className='relativev py-[40px] '>
    <div className='w-[100%] max-w-[1460px] mx-auto flex lg:flex-row flex-col items-start'>
     <div className="w-[100%] max-w-[608px] pl-[40px] pr-[10px] flex flex-col items-center relative lg:min-h-[1000px] lg:mb-[0] mb-[30px]"> 
       <div className="w-full max-w-[506px] sticky top-[140px]">
            <h2 className='lg:text-[36px] text-[28px] font-[600] leading-[35px] mt-[20px] mb-[10px]' style={{
                fontFamily: "var(--font-raleway)",
            }}>Custom Design for Shopify</h2>
       </div>
     </div> 
     <div className='w-[100%] max-w-[851px] lg:px-[2.5rem] px-[20px] relative lg:mt-[0px] mt-[50px]'>
