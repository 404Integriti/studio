        ...
        >
          <div className="flex flex-col  mt-[40px] sm:mt-[80px] max-w-[620px]  lg:mx-[34px] xl:mx-[48px] ">
            ...
            <p className="text-[14px] w-[84%] ">
              Design isn’t decoration—it’s strategy. At Integriti Studio, we
              craft Shopify designs that not only look amazing but are built
              with conversion at the core. Every element has a purpose. Every
              layout is intentional. Because when form meets function, thats
              when store scale.
            </p>
