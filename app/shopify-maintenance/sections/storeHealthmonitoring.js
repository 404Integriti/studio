...
import { healthmonitor } from "../../components/customThemePoints";
...
const StoreHealthMonitoring = () => {
  return (
    <section className="bg-[#f8f8f8]">
     ...
     <h2 className="md:text-[32px] text-[24px] font-[600] text-center    leading-[36px] text-[#333333] raleway mt-[30px] mb-[30px] pb-[25px]">Store Health Monitoring</h2>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {healthmonitor.map((feature, index) => (
          <div
            key={index}
