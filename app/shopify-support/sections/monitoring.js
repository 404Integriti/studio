import { shopifymonitoringData} from "../../components/customThemePoints";
import Image from "next/image";
import Link from "next/link";

export default function Monitoringshopify() {
  return (
    <section className="py-[40px]">
      <div className="w-[100%] max-w-[1216px] mx-auto flex px-[20px] lg:flex-row flex-col lg:gap-[0px] gap-[50px]">
        {/* Left column */}
        <div className="w-[100%] lg:max-w-[50%] max-w-[100%]">
          ...
          <div className="flex flex-col gap-[30px] mt-[30px]">
            {shopifymonitoringData.map((service, index) => (
              <div
                key={index}
