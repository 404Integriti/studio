...
const impacts = [
  {
    title: "Efficiency",
    description: "Appointment bookings became faster and more streamlined.",
    bgColor: "bg-[#cceae7]",
    image: '/cost.png',
  ...
  {
    title: "Speed",
    description: "Improved site performance lowered bounce rates and enhanced user satisfaction.",
    bgColor: "bg-[#fadbd1]",
    image: '/improved.png',
    headingClass: "text-[32px] font-[600] mb-[-15px] text-[#333] leading-[36px]", 
    paraClass: "text-[16px] leading-[22px] font-[400] text-[#666] px-[20px]" 
  ...
  {
    title: "Feedback",
    description: "Received 98% positive reviews for its ease of use and clean design.",
    bgColor: "bg-[#cceae7]",
    image: '/cost.png',
    headingClass: "text-[32px] font-[600] mb-[-15px] text-[#333] leading-[36px]",
    paraClass: "text-[16px] leading-[22px] font-[400] text-[#666] px-[20px]"
