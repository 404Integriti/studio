    ...
    <section className='custom-wordpress-solution' style={{
        ...
        <div className='w-[100%] max-w-[1440px] mx-auto flex lg:flex-row flex-col justify-center items-center
         ...
         <div className='w-[100%] max-w-[700px] lg:max-w-[40%] lg:pl-[40px] px-[20px]'>
            ...
            heading={
                <>
                Custom <span className='hero-orange'>WordPress</span> Solutions, Built for Flexibility & Scale
                </>
            }
            ...
            />
         <Link href='/wordpress-development-services' className='px-[10px] py-[15px] bg-[#e64a19] rounded-[30px] w-[100%] max-w-[241px] h-[42px]
                       text-[16px] text-[#fce4ec] font-[400] hover:bg-[#ED8104] duration-300' style={{
                        fontFamily: 'Raleway, sans-serif',
                       }}>Explore WordPress Services</Link>
         </div>
         <div className='w-[100%] max-w-[851px] lg:max-w-[55%] lg:px-[40px] lg:pl-[101px] '>
            <DemoStepCarousel />
         </div>
        </div>
    </section>
