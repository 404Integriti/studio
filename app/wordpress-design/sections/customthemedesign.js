        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4 lg:px-[0px] px-[20px]">
            {accordionItems.map((item) => (
              <div key={item.id} className="rounded-[15px] shadow-[0_2px_20px_12px_#effefb] transition-all duration-500 ease mb-[23px]">
                <button
                  onClick={() => toggleAccordion(item.id)}
                  className="w-full text-left flex flex-row-reverse items-center justify-end transition-all duration-500 ease"
                >
                  <span 
                    className="md:text-[22px] text-[18px] font-[700] text-[#333] md:leading-[78px] leading-[30px] h-[80px] transition-all duration-500 ease"
                    style={{
                       fontFamily: "var(--font-raleway)"
                    }}
                  >
                  ...
                  <span 
                    className="text-[40px] text-[#333] mx-[25px] transition-all duration-500 ease"
                    style={{
          ...
          <div className="flex justify-start lg:px-[0px] px-[20px]">
