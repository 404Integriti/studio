import shopifyData from '../../components/customThemePoints';
import SectionHeading from "../../components/secheading";
import Image from 'next/image';
export default function ShopifyPlusSection() {
  return (
    <section className="flex flex-col md:flex-row items-center justify-between py-10 px-[10px] bg-white max-w-[1440px] mx-auto">
      <div className="w-full md:max-w-[550px] md:ml-[60px] text-left md:text-left mb-6 md:mb-0">
         <SectionHeading className="text-left mb-4 font-semibold" text="Shopify Plus Expertise"/>
