  ...
  return (
        <section className="pt-[60px] md:pt-[80px] pb-[60px] w-full ">
              <div className="max-w-[1400px] px-[20px] mx-auto">
                ...
                <div className="flex flex-wrap justify-center gap-x-[20px] md:gap-y-[125px] gap-y-[90px] mt-[100px] lg:pt-[50px]
                                  pt-[30px]">
                  {Data.map((card, index) => (
                    <WordPressWhitelabelCard key={index} {...card} className={`!max-w-[385px] !min-w-[173px]
        ${index === 3 ? "!h-[190px]" : "!min-h-[280px]"}`} headingStyle="px-[15px] !text-[19px] sm:!text-[24px] !font-[600] mt-[20px] mb-[10px] text-center " desStyle="text-[#333] text-[14px] font-[400] leading-[20px] min-[1440px]:leading-[23px] pl-[20px] sm:pl-[22px] pr-[22px] mb-[10px] min-[1440px]:mx-auto text-center"/>
                  ))}
                </div>
              </div>
            </section>
