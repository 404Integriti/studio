  ...
  const accordionItems = [
    {
      ...
      description: "Dynamic discount logic tailored by customer region to drive localized marketing strategies. ",
      isActive: activeAccordion === 1
    },
    {
      id: 2,
      title: "Live Pricing Sync",
      description: "Consistent and accurate pricing powered by ERP connectivity.",
      isActive: activeAccordion === 2
    },
    {
      id: 3,
      title: "Automated Order Processing ",
      description: "Simplified backend with draft order automation, reducing manual errors.",
      isActive: activeAccordion === 3
    },
    {
      id: 4,
      title: "Enhanced Checkout Flow ",
      description: "Users redirected smoothly to customized checkout, improving conversion and clarity. ",
